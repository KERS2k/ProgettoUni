...
class GameManager:
    def __init__(self):
        ...
        self.conn = sqlite3.connect('videogames.db')

    def table_exists(self):
        conn = sqlite3.connect('videogames.db')
        cursor = conn.cursor()

        cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='VideoGames'")
    ...
    def create_table(self):
        ...
        cursor.execute('''CREATE TABLE VideoGames (
    ...
    def insert_games_data(self):
        ...
        cursor.executemany('INSERT INTO VideoGames VALUES (?, ?, ?, ?, ?)', games_data)
